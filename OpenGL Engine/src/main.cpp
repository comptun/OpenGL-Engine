...
static Shader parseShaders(const std::string filePath)
{
...
int main(void)
{
    ...
    Shader parsedShaders = parseShaders("basic.shader");

    unsigned int shader = createShader(parsedShaders.vertex, parsedShaders.fragment);
